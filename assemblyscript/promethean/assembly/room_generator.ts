...
export class Room{
    ...
    constructor(room_height: i32, room_width: i32, room_x: i32, room_y: i32, room_type: RoomType=RoomType.Rectangle){
        ...
        this.m_position = new Point(room_x, room_y);
        this.m_room_center = new Point(this.m_position.x() + this.m_height / 2, this.m_position.y() + this.m_width / 2);
        this.m_bottom_left = new Point(this.m_position.x() + this.m_height - 1, this.m_position.y());
        this.m_top_right = new Point(this.m_position.x(), this.m_position.y() + this.m_width - 1);
        this.m_bottom_right = new Point(this.m_position.x() + this.m_height - 1, this.m_position.y() + this.m_width - 1);

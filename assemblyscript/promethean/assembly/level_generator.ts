...
export class LevelGenerator{
    ...
    constructor(options: Options){
        ...
        this.m_random = new PseudoRandom();
        this.m_room_generator = new RoomGenerator(this.m_random);
    ...
    generate(): Level{
        ...
        level.set_statistics(rooms.length, corridors.length, corridors.length == rooms.length - 1, room_centers);
